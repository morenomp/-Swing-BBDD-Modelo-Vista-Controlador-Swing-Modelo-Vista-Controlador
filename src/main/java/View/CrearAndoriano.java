...
public class CrearAndoriano extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        crearandoriano.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/guardar2.jpg"))); // NOI18N
        ...
        getContentPane().add(crearandoriano, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 630, 340, 80));

        jPanel1.setBackground(new java.awt.Color(45, 45, 45));
        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        jPanel1.add(nombreciudadano, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 40, 112, 30));
        jPanel1.add(aenar, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 40, -1, 30));

        jLabel1.setBackground(new java.awt.Color(255, 255, 255));
        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 0));
        jLabel1.setText("NOMBRE:");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 40, 76, 30));

        jLabel2.setBackground(new java.awt.Color(255, 255, 255));
        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 0));
        jLabel2.setText("AENAR:");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 40, 62, 29));

        jLabel3.setBackground(new java.awt.Color(255, 255, 255));
        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 0));
        jLabel3.setText("RANGO:");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 120, 76, 30));

        rango.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Entrenador", "Defensor", "Luchador", "Caballero" }));
        jPanel1.add(rango, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 120, 112, 30));

        jLabel4.setBackground(new java.awt.Color(255, 255, 255));
        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 0));
        jLabel4.setText("RESIDE:");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 120, 62, 30));
        ...
        jPanel1.add(nombreplaneta, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 120, 92, 30));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 310, 492, 201));

        jLabel7.setFont(new java.awt.Font("Roboto Black", 1, 24)); // NOI18N
        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/createAnd.jpg"))); // NOI18N
    ...
    private void formWindowGainedFocus(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowGainedFocus
        ...
        DAOSQL daoCrearA = new DAOSQL();
        
        nombreplaneta.removeAllItems();
        try {
            for (Planeta p : daoCrearA.readPlanet()) {
