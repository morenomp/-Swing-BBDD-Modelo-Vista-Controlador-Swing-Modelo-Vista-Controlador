...
public class ModificarNibiriano extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        crearnibiriano.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/modificar.jpg"))); // NOI18N
        ...
        getContentPane().add(crearnibiriano, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 630, 340, 80));
        ...
        jPanel1.add(nombreciudadano, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 50, 117, 30));
        ...
        jPanel1.add(grupoalimenticio, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 130, 117, 30));

        jLabel2.setBackground(new java.awt.Color(255, 255, 255));
        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 0));
        jLabel2.setText("GRUPO:");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 130, 70, 30));

        jLabel4.setBackground(new java.awt.Color(255, 255, 255));
        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 0));
        jLabel4.setText("RESIDE:");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 50, 59, 30));
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/modificarNib.jpg"))); // NOI18N
    ...
    private void formWindowGainedFocus(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowGainedFocus
        ...
        try {
            ...
            for (Planeta p : daoCN.readPlanet()) {
